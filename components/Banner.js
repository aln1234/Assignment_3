...
function Banner() {
    ...
    return (
        <div className=" overflow-hidden relative md:max-w-6xl h-[300px] w-[600px] md:h-[300px] md:w-[1200px] bg-blue-600 shadow-md rounded-lg ml-[200px] -mt-12">
           ...
           <div className="text-center mt-16">
               ...
               Seeking Collaboration?
                 ...
                 <div className="mt-8  font-mono text-[#05f] w-32 h-14 items-center ml-[240px] md:ml-[500px] bg-[#ffdc1c] cursor-pointer hover:bg-yellow-500" >
